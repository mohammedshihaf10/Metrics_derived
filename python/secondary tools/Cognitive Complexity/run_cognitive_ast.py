...
def main() -> int:
    ap = argparse.ArgumentParser(description="Install or run cognitive-ast against a provided repo.")
    ...
    return subprocess.run([resolve_python(), str(TOOL_DIR / "analyze_cognitive_ast.py"), str(repo), str(output), *normalize(args.tool_args)], cwd=str(ROOT)).returncode
