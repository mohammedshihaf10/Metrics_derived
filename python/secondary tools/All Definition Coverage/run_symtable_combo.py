...
def main() -> int:
    ...
    return subprocess.run([resolve_python(), str(TOOL_DIR / "analyze_definitions.py"), str(repo), str(output), *normalize(args.tool_args)], cwd=str(ROOT)).returncode
